  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final confirmationUpdateParkingSpotResponse = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '3totr275' /* Your parking spot has been suc... */,
                        ),
                        textAlign: TextAlign.center,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'xxe7z8rx' /* We've sent a confirmation emai... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'yvxrde2h' /* Please present this QR code up... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(50.0, 32.0, 50.0, 0.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          FFAppState().neuchatel = false;
                          FFAppState().constance = false;
                          FFAppState().biwa = false;
                          FFAppState().n1 = false;
                          FFAppState().n2 = false;
                          FFAppState().n3 = false;
                          FFAppState().n4 = false;
