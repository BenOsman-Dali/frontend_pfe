...
class _UserDetailsWidgetState extends State<UserDetailsWidget> {
  ...
  void initState() {
    ...
    _model.vehicleTextController ??= TextEditingController();
    _model.vehicleFocusNode ??= FocusNode();
  }
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'wsfhty6h' /* Fill out the information below... */,
                              ),
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.vehicleTextController,
                              focusNode: _model.vehicleFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'm6lwlo8b' /* Vehicle Brand * */,
                                ),
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                              ...
                              cursorColor: Color(0xFF4B39EF),
                              validator: _model.vehicleTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
