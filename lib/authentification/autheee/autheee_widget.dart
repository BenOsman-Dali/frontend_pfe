              ...
              children: [
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '8l8sk1iw' /* Fill out the information below... */,
                                ),
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(RecoverPasswordWidget.routeName);
                      },
                      text: FFLocalizations.of(context).getText(
                        'b7regp3t' /* Forgot Password? */,
                      ),
                      options: FFButtonOptions(
                        height: 44.0,
                        padding: EdgeInsetsDirectional.fromSTEB(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'o2msra5y' /* You do not have an account? */,
                      ),
